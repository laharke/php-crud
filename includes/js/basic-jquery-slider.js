 ...
 */ (function ($) {
    $.fn.bjqs = function (options) {
        ...
        if (settings.showMarkers && slideCount > 1) {
            ...
            var $markerContainer = $('<div class="bjqs-markers" style="float: '+settings.markersPos+';"></div>'),
                $marker, markers, offset;

	    // Agrego las flechitas
	    $('<div class="bjqs-markers-arrow-left" style="left: 10px; top: 3px;"></div>').click(function(e){
                e.preventDefault();
                if (!animating) {
                    bjqsGo(back, false);
                }		
	    ...
	    $('<div class="bjqs-markers-arrow-right" style="right: 10px; top: 3px;"></div>').click(function(e){
                e.preventDefault();
                if (!animating) {
                    bjqsGo(forward, false);
                }				
...
//                        $marker = $('<span><div href="#">' + key + '</div></span>');
                        $marker = $('<span><div href="#">&nbsp;&nbsp;&nbsp;</div></span>');
                    }
                } else {
                    key++;
//                    $marker = $('<span><div href="#">' + key + '</div></span>');
                    $marker = $('<span><div href="#">&nbsp;&nbsp;&nbsp</div></span>');
                }
            ...
            markers = $markerContainer.children('span');
